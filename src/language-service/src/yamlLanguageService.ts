...
import { TextDocument, TextEdit, Diagnostic } from "vscode-languageserver-protocol";
...
import { LanguageSettings, Thenable } from "yaml-language-server/out/server/src/languageservice/yamlLanguageService";
